...
const AboutImage1 = new Proxy({"src":"/_astro/about-image-1.DziLt8JV.webp","width":320,"height":185,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/UniversidadUPC-Trabajos/CAS-UPC/Landing-Page/proyecto/Imagenes/about-image-1.webp";
							}
...
const AboutImage2 = new Proxy({"src":"/_astro/about-image-2.38ChisE_.webp","width":333,"height":185,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/UniversidadUPC-Trabajos/CAS-UPC/Landing-Page/proyecto/Imagenes/about-image-2.webp";
							}
