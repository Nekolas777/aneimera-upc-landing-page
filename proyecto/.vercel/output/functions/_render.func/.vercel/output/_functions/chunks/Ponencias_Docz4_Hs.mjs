...
const PonenciaUno = new Proxy({"src":"/_astro/ponencia1.BuvKu0lY.webp","width":700,"height":500,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/UniversidadUPC-Trabajos/CAS-UPC/Landing-Page/proyecto/Imagenes/ponencia1.webp";
							}
...
const PonenciaDos = new Proxy({"src":"/_astro/ponencia11.CvVOXG9h.webp","width":700,"height":500,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/UniversidadUPC-Trabajos/CAS-UPC/Landing-Page/proyecto/Imagenes/ponencia11.webp";
							}
