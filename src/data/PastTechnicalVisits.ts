interface CardPastTechnicalVisits {
  visit_img: string;
  title: string;
  visit_date?: string;
  description: string;
...
export const cards: CardPastTechnicalVisits[] = [
  {
      "visit_img": "https://www.udep.edu.pe/hoy/wp-content/uploads/sites/49/2017/06/LINDLEY-5-ok.jpg",
  ...
  {
      "visit_img": 'https://www.administracion.usmp.edu.pe/wp-content/uploads/2019/08/alumnos-visitan-backus-1024x702.jpg',
